...
function navigateAASTree(data, elementRequested, pathToTheElement) {
    if (elementRequested === pathToTheElement[0]) {
        ...
        switch (getModelType(data.modelType)) {
            case 'Entity':
            ...
            default:
                config.getLogger().error(context, 'QUERY-002: New ModelType detected, update navigateAASTree function');
                break;
        }
    }
}
...
function extractAASData(data) {
    ...
    switch (getModelType(data.modelType)) {
        ...
        case 'MultiLanguageProperty':
            return data.value;
        default:
            config.getLogger().error(context, 'QUERY-002: New ModelType detected, update extractAASData function');
            break;
    }
}
