...
async function getSubmodels(aasServerEndpoint, apiVersion, submodels) {
    ...
    try {
        ...
        extractSubmodelsFromResponse(submodels, data);
    } catch (error) {
        console.error(error);
    }
}
...
function extractSubmodelsFromResponse(submodels, data) {
